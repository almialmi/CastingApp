...
class LikeDislikeCompute extends StatefulWidget {
  final COmputationPost post;

  const LikeDislikeCompute({Key key, this.post}) : super(key: key);

  @override
  _LikeDislikeComputeState createState() => _LikeDislikeComputeState();
}

class _LikeDislikeComputeState extends State<LikeDislikeCompute> {
  ...
  Widget build(BuildContext context) {
    print("post owner id is ${widget.post.id}");
